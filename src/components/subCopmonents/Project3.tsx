  ...
  return (
    ...
    >
      <div className="w-full lg:w-1/2 flex flex-col items-start gap-6">
        ...
        >
          <p className="text-gray-300 leading-relaxed text-left flex flex-col gap-5 text-sm md:text-base">
            {t("projects.work3.description")}
            <span>
        ...
        >
          {(t.raw("projects.work3.techStack") as string[]).map(
            (item, index) => (
              <span
                key={index}
        ...
        >
          <a
            href={t("projects.work3.projectLink")}
            target="_blank"
            rel="noreferrer"
      ...
      <div className="w-full lg:w-1/2">
        ...
        >
          ...
          <img
            className="relative w-full h-auto shadow-2xl shadow-purple-900 rounded-2xl border border-slate-800 transition-transform duration-500 group-hover:scale-[1.02]"
