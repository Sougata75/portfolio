...
function Header() {
  ...
  return (
    <div className="sticky top-0 z-55 w-full p-5 bg-gray-950 flex justify-center items-center">
        <nav className="w-[80%] flex justify-between items-center">
            <div className="w-[40%]">
              <img className="w-35 " src="/Logo.png"/>
            </div>
            ...
            <div className="md:w-[10%] flex items-center justify-start gap-2">
              ...
              <p onClick={() => handleLanguageChange("jp")} className={`${language === "en"? "block":"hidden"} text-yellow-500 text-xl capitalize cursor-pointer`}>english</p>
              ...
              <p onClick={() => handleLanguageChange("en")} className={`${language === "jp"? "block":"hidden"} text-purple-500 text-xl capitalize cursor-pointer`}>japanese</p>
            </div>
        </nav>
    </div>
  )
